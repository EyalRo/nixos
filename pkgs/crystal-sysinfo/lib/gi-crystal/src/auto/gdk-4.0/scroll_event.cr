...
module Gdk
  ...
  class ScrollEvent < Event
    ...
    def self.relative_direction(event : Gdk::Event) : Gdk::ScrollRelativeDirection
      # gdk_scroll_event_get_relative_direction: (None)
      # @event:
      # Returns: (transfer none)

      # C call
      _retval = LibGdk.gdk_scroll_event_get_relative_direction(event)
